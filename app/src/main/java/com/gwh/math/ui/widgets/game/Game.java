...
public class Game {
    ...
    public final String str = "360000000004230800000004200070460003820000014500013020001900000007048300000000045";
    ...
    public Game() {
        ...
        String gameStatus = CacheUtil.INSTANCE.getGameStatus();
        String s = "";
        Random random = new Random();
        int i = random.nextInt(Constants.INSTANCE.getLists().size()-1);
        if (gameStatus.equals("2")){
            s = Constants.INSTANCE.getKunNanLists().get(i);
        }else if (gameStatus.equals("3")){
            s = Constants.INSTANCE.getDiYuLists().get(i);
        }else {
            s = Constants.INSTANCE.getLists().get(i);
        }

        sudoku = fromPuzzleString(s);
